...
fileprivate extension DetailsController {
    var finalFrame: CGRect {
        return CGRect(x: layoutProvider.itemSpacing, y: layoutProvider.itemSpacing, width: UIScreen.main.bounds.width - layoutProvider.itemSpacing * 2, height: layoutProvider.largeRowHeight)
    }
}
