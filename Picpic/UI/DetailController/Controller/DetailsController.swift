...
class DetailsController: UIViewController, Interactive {
    ...
    lazy var collectionView: UICollectionView = {
        let collection = UICollectionView(frame: .zero, collectionViewLayout: layoutProvider.layout(from: self))
...
extension DetailsController: UICollectionViewDelegate {
    func makeDataSource() {
        dataSource = DataSource(collectionView: collectionView) { collectionView, indexPath, picture in
